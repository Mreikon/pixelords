...
#You must have py2exe module installed. Will not work with pygame 1.9.1
#Must be copied to the root folder (where are pixelord.py) whit pixelords.ico
...
script = "pixelords.py"  # Starting .py or .pyw script
dest_file = "pixelords"   # Final name of .exe file
dest_folder = "pixelords" # Final folder for the files
icon_file = "pixelords.ico"  # Icon file
extra_data = ["gfx", "sfx", "maps", "resources", "music", "config.txt", "README.txt", "COPYING.txt", "AUTHORS.txt"]        # Extra data to copy in the final folder
extra_modules = ["lib"]      # Extra modules to be included in the .exe (leave blank if no extra modules)
